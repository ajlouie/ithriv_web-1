...
export class CommonsDatasetCreateEditComponent implements OnInit {
  ...
  hipaaOptions = [
    'NONE (De-ID)',
    'NAMES, INITIALS, FIRST 3 LETTERS of LAST NAME (HSD)',
    'ADDRESSES and equivalent GEOCODES (HSD)',
    'CITY, ZIP, or equivalent GEOCODES (LDS)',
    'First 3 digits of ZIP and if population <20K ZIP changed to 000 (De-ID)',
    'STATE or larger regions (De-ID)',
    'DATES with MONTH/DAY/YEAR (LDS)',
    'AGES > 90 are reflected in data (LDS)',
    'DATES using only YEAR and NO AGES > 90 (De-ID)',
    'EMAIL or PHONE or FAX # (HSD)',
    'SOCIAL SECURITY # or last 4 digits (HSD)',
    'MEDICAL RECORD # or ACCOUNT # or HEALTH PLAN BENEFICIARIES (HSD)',
    'CERTIFICATE # or LICENSE # (HSD)',
    'VEHICLE ID, SN, or Plate # (HSD)',
    'DEVICE ID or SN or IP address; Web URLs (HSD)',
    'BIOMETRIC IDs or FINGER PRINTS or VOICE RECORDINGS or FULL FACE IMAGES (HSD)',
    'OTHER UNIQUE IDENTIFIERS (HSD)',
  ];
